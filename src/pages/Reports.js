...
=======
  ...
  const columns = [
    ...
    {
      title: "OCR", dataIndex: "ocr", key: "ocr",
    ...
    <>
      ...
      <div className="layout-content">
        <div className="" style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <Button type="primary" onClick={() => handleApplyFilters(pagination.current, pagination.pageSize)} style={{ fontSize: "1rem", backgroundColor: "#c91245", marginRight: "10px" }}>Apply filters</Button>
          {filterActive ?
            <Button type="primary" onClick={resetFilter} style={{ fontSize: "1rem", backgroundColor: "#c91245", marginRight: "10px" }}>Reset Filter</Button>
            : null}
          <Button type="primary" icon={<DownloadOutlined />} size='large' style={{ fontSize: "1rem", backgroundColor: "#c91245" }} onClick={downloadExcel}>
            Download
          </Button>
