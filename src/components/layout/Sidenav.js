...
<<<<<<< Updated upstream
=======
      fill={active === "" || page === "dashboard-home" ? "#fff" : color}
>>>>>>> Stashed changes
    >
      <path
      ...
      <Menu theme="light" mode="inline">
        <Menu.Item key="1">
          <NavLink to="/" onClick={() => setActive()} style={{
            background: active === "/" || page === "" ? "#fff" : "",
            boxShadow: active === "/" || page === "" ? "0 20px 27px rgb(0 0 0 / 5%);" : "",
          }}>
            <span
              className="icon"
              style={{
                background: active === "" || page === "" ? color : "",
>>>>>>> Stashed changes
              }}
            >
              {dashboard}
...
=======
            <span className="label" style={{
              color: active === "" || page === "dashboard-home" ? color : "",
            }}>Dashboard</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="2">
